      ...
      yield call(() =>
        UploadAvatar.httpRequest.generator(data, {
          * onStart({ cancelTokenSource }): SagaIterator {
            yield apply(setAvatarUploadCancelTokenSource, setAvatarUploadCancelTokenSource, [cancelTokenSource]);
          },
          * onSuccess(payload: IAvatar): SagaIterator {
            yield apply(setAvatarUploadCancelTokenSource, setAvatarUploadCancelTokenSource, [undefined]);
