...
import { WithBackground, BaseBtn, Modal } from '@components';
  ...
  return (
    <WithBackground onBackgroundClick={hideChangePhoto}>
      <Modal
        title={
          <>
            <PhotoSvg viewBox='0 0 25 25' className='photo-editor__icon' />

            <span> {t('photoEditor.title')} </span>
          </>
        }
          ...
          <div className='photo-editor'>
            ...
            <div className='change-photo__btn-group'>
              <div className='change-photo__modify-btns'>
                <button type='button' onClick={mirror} className='change-photo__modify-btn'>
                ...
                <button type='button' onClick={rotate} className='change-photo__modify-btn'>
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'>
                    <path
                      fillRule='evenodd'
        ...
        buttons={[
          <BaseBtn className='change-photo__confirm' variant='contained' width='auto' color='primary' onClick={submitChange}>
            {t('changePhoto.confirm')}
          </BaseBtn>,
          <BaseBtn className='change-photo__cancel' variant='contained' width='auto' color='secondary' onClick={hideChangePhoto}>
