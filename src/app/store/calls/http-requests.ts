...
export const CallsHttpRequests = {
  endCall: httpRequestFactory<AxiosResponse, EndCallApiRequest>(`${ApiBasePath.NotificationsApi}/api/calls/end-call`, HttpRequestMethod.Post),
  ...
  cancelCall: httpRequestFactory<AxiosResponse, CancelCallApiRequest>(`${ApiBasePath.NotificationsApi}/api/calls/cancel-call`, HttpRequestMethod.Post),
  ...
  declineCall: httpRequestFactory<AxiosResponse, DeclineCallApiRequest>(`${ApiBasePath.NotificationsApi}/api/calls/decline-call`, HttpRequestMethod.Post),
  ...
  getCalls: httpRequestFactory<AxiosResponse<Call[]>, GetCallsApiRequest>(`${ApiBasePath.MainApi}/api/calls/search`, HttpRequestMethod.Post),
};
