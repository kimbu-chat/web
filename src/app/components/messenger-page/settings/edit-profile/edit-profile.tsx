      ...
      <div className='edit-profile'>
        ...
        <div className='edit-profile__profile-data'>
          <div className='edit-profile__data-category'>
            ...
            <button type='button' onClick={changeIsEditNameDisplayed} className='edit-profile__edit'>
          ...
          <div className='edit-profile__data-category'>
            ...
            <div className='edit-profile__data-field'>
              <div className='edit-profile__data-value'>{parsePhoneNumber(myProfile?.phoneNumber!).formatInternational()}</div>
              <div className='edit-profile__data-name'>{t('editProfile.mobile')}</div>
            </div>
            <button type='button' onClick={changeIsEditPhoneDisplayed} className='edit-profile__edit'>
              <EditSvg viewBox='0 0 25 25' />
            </button>
          </div>
          <div className='edit-profile__data-category'>
            ...
            <button type='button' onClick={changeIsEditUsernameDisplayed} className='edit-profile__edit'>
              <EditSvg viewBox='0 0 25 25' />
            </button>
          </div>
        </div>
