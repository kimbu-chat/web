  ...
  return (
    <BackgroundBlur hiding={closeInitiated} onClick={animatedClose}>
      <div className={rootClass}>
        <div className={classNames(`${BLOCK_NAME}__main`)}>
          ...
          <div className={classNames(`${BLOCK_NAME}__media-wrapper`)}>
            ...
            {attachmentsArr[currentAttachmentIndex].type === FileType.Video && (
              <video
                ...
                controls
                src={attachmentsArr[currentAttachmentIndex].url}
                className={classNames(`${BLOCK_NAME}__player`)}
              />
            )}
            {attachmentsArr.length !== 1 && (
              <div className={classNames(`${BLOCK_NAME}__position-pointer`)}>
        ...
        <button className={classNames(`${BLOCK_NAME}__close`)} type="button">
