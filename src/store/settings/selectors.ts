...
export const getBlockedUsersLoadingSelector = (state: RootState) => state.settings.blackList.isLoading;
export const getSessionsSelector = (state: RootState) => state.settings.sessionList.sessions;
export const getSessionsLoadingSelector = (state: RootState) => state.settings.sessionList.isLoading;
