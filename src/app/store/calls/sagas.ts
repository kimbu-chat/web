...
import { select, put, take, race, delay, takeLatest, takeEvery, call, spawn } from 'redux-saga/effects';
import { AxiosResponse } from 'axios';
import { getMyIdSelector, getMyProfileSelector } from '../my-profile/selectors';
...
import { CallApiRequest, CandidateApiRequest, IInCompleteConstraints } from './models';
import { getCallInterlocutorSelector, doIhaveCall } from './selectors';
...
export function* callAcceptedSaga(action: ReturnType<typeof InterlocutorAcceptedCall.action>): SagaIterator {
