...
import { UpdateMyProfileActionData, UserPreview, UpdateNicknameActionData, CheckNicknameActionData, UploadAvatarReqData } from './models';
...
export namespace MyProfileActions {
  ...
  export const updateMyProfileSuccessAction = createAction('UPDATE_MY_PROFILE_INFO_SUCCESS')<UpdateMyProfileActionData>();
  ...
  export const checkNicknameAvailabilityAction = createAction('CHECK_NICKNAME_AVAILABILITY')<CheckNicknameActionData, Meta>();
