...
import { ForwardMessagesSuccess } from './features/forward-messages/forward-messages-success';
...
export namespace ChatActions {
  ...
  export const forwardMessagesSuccess = ForwardMessagesSuccess.action;
