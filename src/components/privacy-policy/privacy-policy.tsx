  ...
  return (
    <BackgroundBlur hiding={closeInitiated} onClick={animatedClose}>
      <div onClick={stopPropagation} className={rootClass}>
        <div className={classNames(`${BLOCK_NAME}__header`)}>
          <div className={classNames(`${BLOCK_NAME}__top-group`)}>
            <h1>Privacy Policy</h1>
            <button
              type="button"
              onClick={animatedClose}
              className={classNames(`${BLOCK_NAME}__close`)}>
              <CloseSVG />
            </button>
          </div>
          <div className={classNames(`${BLOCK_NAME}__h-line`)} />
        </div>
        <div className={classNames(`${BLOCK_NAME}__text-container`)}>
          <p>
        ...
        <button type="button" onClick={animatedClose} className={classNames(`${BLOCK_NAME}__btn`)}>
          Close
        </button>
      </div>
    </BackgroundBlur>
