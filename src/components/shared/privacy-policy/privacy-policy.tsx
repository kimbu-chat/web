    ...
    <div onClick={stopPropagation} className="policy-modal">
      ...
      <div className="policy-modal__text-container">
        <p>
          ...
          explains how you can control the information we collect, how this information will be
          used, and how to contact us. This document describes how we protect your personal data.
        </p>
        ...
        <p>
          ...
          typically contain any information that personally identifies someone, but personal data
        ...
        <ul>
          <li>
            ...
            websites and use their features. These Cookies make sure you can view the websites and
            use them in a proper way. They also give you access to secured parts of the ARKONI
            websites. Examples of functional cookies: SID, PHPSESSID, wp-settings-X,
        ...
        <p>
          We will use your email address, phone number, or other contact information you provide us
          by written or oral means for contacting you and providing you with the services and
          information that you request; it also allows us to correctly respond to your comments and
          questions.
        </p>
        <h2>3.2 For establishing business relations</h2>
        <p>
          If you are an existing customer of ARKONI or we reasonably believe that you might want to
          be our customer, we will use your email address, phone number, and other contact
        ...
        <p>
          ...
          information about our services, recent updates, latest products, case studies, and
          research.
        </p>
        ...
        <p>
          ...
          Leadfeeder, Google Tag Manager, Facebook, Mailchimp and Hotjar all of which are compliant
          with CCPA and other regulations. Their privacy policies can be found here:
        </p>
        ...
        <p>
          ...
          protection regulations (for example, to parties in Belarus). However, to protect your
          data, we always sign contracts with our subcontractors that contain provisions for the
        ...
        <p>
          7.1 <b>Request information</b> about whether we hold personal information about you, and,
          if so, what that information is and why we are holding or using it.
        </p>
        <p>
        ...
        <p>
          ...
          particular situation which makes you want to object to processing on this ground. You also
        ...
        <p>
          ...
          collection, processing and transfer of your personal information for a specific purpose at
          any time. Once we have received notification that you have withdrawn your consent, we will
          no longer process your information for the purpose or purposes you originally agreed to,
          unless we have another legitimate basis for doing so in law. The withdrawal of consent
          will not affect the lawfulness of processing based on consent prior to its withdrawal.
        </p>
        <h2>
        ...
        <p>
          ...
          is another security measure to ensure that personal information is not disclosed to any
