...
interface IInitialDeleteMessageModalProps {
...
export const InitialDeleteMessageModal: React.FC<
  IInitialDeleteMessageModalProps & IModalChildrenProps
...
const DeleteMessageModal: React.FC<IDeleteMessageModalProps & IInitialDeleteMessageModalProps> = ({
  onClose,
  ...props
}) => (
  <Modal closeModal={onClose}>
    {(animatedClose: () => void) => (
      <InitialDeleteMessageModal {...props} animatedClose={animatedClose} />
    )}
  </Modal>
);
