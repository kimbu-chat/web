...
export const getSelectedChatRecordingsSelector = (state: RootState) =>
  (
    state.chats.chats[state.chats.chatInfo.chatId || -1] ||
    state.chats.chats[state?.chats?.selectedChatId || -1]
  )?.recordings;
...
export const getInfoChatIdLoadedSelector = (state: RootState) =>
  (
    state.chats.chats[state.chats.chatInfo.chatId || -1] ||
    state.chats.chats[state?.chats?.selectedChatId || -1]
  )?.id;

export const getInfoChatIdSelector = (state: RootState) => state.chats.chatInfo.chatId;
